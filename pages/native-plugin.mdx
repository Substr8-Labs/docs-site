...
RunProof does not yet claim full multi-agent, full state-transition, or full policy/ledger proof. Those are part of the broader [protocol roadmap](/protocol).
