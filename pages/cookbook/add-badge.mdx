...
```markdown
[![RunProof Verified](https://runproof.substr8labs.com/badge/YOUR_PROOF_ID)](https://runproof.substr8labs.com/proof/YOUR_PROOF_ID)
```
...
[![RunProof Verified](https://runproof.substr8labs.com/badge/proof_ccfe7c4abd014eab)](https://runproof.substr8labs.com/proof/proof_ccfe7c4abd014eab)
```
...
```markdown
![RunProof](https://runproof.substr8labs.com/badge/PROOF_ID)
```

### With Status

```markdown
![RunProof](https://runproof.substr8labs.com/badge/PROOF_ID?style=status)
```
...
```markdown
![RunProof](https://runproof.substr8labs.com/badge/PROOF_ID?style=minimal)
```
